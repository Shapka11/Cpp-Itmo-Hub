...
Этот репозиторий содержит решения лабораторных работ по курсу архитектуры ЭВМ и программированию на C++.

## Схемы (Архитектура ЭВМ)
Работа состоит из моделирования в Logisim и описания на Verilog.

| Лабораторная | Ссылка |
| :--- | :--- |
| **Квадратный корень из half precision** | [Перейти](https://github.com/Shapka11/...) |

### Описание (Lab: Sqrt half precision)
- **Задание:** Реализация итерационного вычисления квадратного корня из 16-битного числа (half precision) с округлением к 0.
- **Инструментарий:** Logisim-evolution, Icarus Verilog.
- **Особенности:** Реализация обработки специальных значений (NaN, Infinity), управление через CLK и ENABLE.
